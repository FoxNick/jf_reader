...
class ReadMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return state.showMenu ? Container(
      child: Stack(
        children: <Widget>[
          GestureDetector(
            onTapUp: state.onTap,
          ...
          // Top Menu
          Positioned(
            top: -Screen.navigationBarHeight * (1 - state.animation.value),
            // top: 0,
            left: 0,
            right: 0,
            child: Container(
              decoration: BoxDecoration(color: state.paperColor, boxShadow: [
          ...
          // Bottom Menu
          Positioned(
              bottom: -(Screen.bottomSafeHeight + 110) * (1 - state.animation.value),
              // bottom: 0,
              left: 0,
              right: 0,
              child: Container(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        BottomItem('亮度', 'res/read_icon_brightness.png',(){
